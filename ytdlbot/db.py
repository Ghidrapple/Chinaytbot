...
class InfluxDB:
    def __init__(self):
        self.client = InfluxDBClient(host=os.getenv("INFLUX_HOST", "192..7.233"), database="celery")
        self.data = None
    ...
    def get_worker_data():
        ...
        return requests.get("https://celery.dsg.app/dashboard?json=1", headers=headers).json()
